...
public class GameBoard extends AbsGameBoard implements IGameBoard{
     ...
     * @param num_of_Rows is the number of rows that the board will be set to
     * @param num_of_Columns is the number of columns the board will be set to
     * @param num_to_win is the number of consecutive markers in order to win
     * @pre none
     * @post
     * [each position in board will be blank]
     * RMAX = num_of_Rows;
     * CMAX = num_of_Columns;
